...
public:
	...
	UFUNCTION()
	void OnRep_Health(const FGameplayAttributeData& OldAttr) const
	{
	...
	UFUNCTION()
	void OnRep_MaxHealth(const FGameplayAttributeData& OldAttr) const
	{
	...
	UFUNCTION()
	void OnRep_Mana(const FGameplayAttributeData& OldAttr) const
	{
	...
	UFUNCTION()
	void OnRep_MaxMana(const FGameplayAttributeData& OldAttr) const
	{
